...
The package is not on CRAN. The shipped posterior draws (~10 MB) exceed
CRAN’s data-size limits.
...
|----|----|
| 4.5.3 σ_(within) obligation | [`estimate_sigma_within()`](https://bradleylab.github.io/leafwax/reference/estimate_sigma_within.md) |
...
MIT. See [LICENSE](https://bradleylab.github.io/leafwax/LICENSE).
