...
- All spatial models (_sp suffix) use exactly 125 knots on a Fibonacci sphere lattice
- Models automatically handle missing scaling data with sensible defaults
- Uncertainty increases appropriately for spatial models due to spatial correlation
- Use `baseline` for simplest applications, `baseline_sp` for spatial applications