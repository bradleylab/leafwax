...
draw at the site. Each value combines the global `beta_oipc` draw with
the spatial slope GP. The function returns the model draws directly; it
does not cap or filter them. Passing the full vector to `invert_d2H()`
